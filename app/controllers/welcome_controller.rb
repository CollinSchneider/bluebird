...
class WelcomeController < ApplicationController
  ...
  def shop
    if params[:products] == 'discounted'
      ...
      @products = Product.queried_products(params[:query]).page(params[:page]).per_page(3)
  ...
  def ending_soon
    if params[:products] == 'discounted'
      ...
      @products = Product.queried_products(params[:query]).order(end_time: :asc).page(params[:page]).per_page(3)
    else
  ...
  def new_arrivals
    if params[:products] == 'discounted'
      ...
      @products = Product.queried_products(params[:query]).order(start_time: :desc).page(params[:page]).per_page(3)
    else
  ...
  def best_sellers
    if params[:products] == 'discounted'
      ...
      @products = Product.queried_products(params[:query]).order(current_sales: :desc).page(params[:page]).per_page(3)
    else
  ...
  def tech
    if params[:products] == 'discounted'
      ...
      @products = Product.where('status = ? AND end_time > ? AND current_sales >= products.goal AND category = ?', 'live', Time.now, 'Tech').page(params[:page]).per_page(3)
        ...
        @products = Product.category_queried_products(params[:query], 'Tech').page(params[:page]).per_page(3)
    elsif params[:products] == 'percent_off'
  ...
  def accessories
    if params[:products] == 'discounted'
      ...
      @products = Product.category_queried_products(params[:query], 'Accessories').page(params[:page]).per_page(3)
    elsif params[:products] == 'percent_off'
  ...
  def home_goods
    if params[:products] == 'discounted'
      ...
      @products = Product.category_queried_products(params[:query], 'Home Goods').page(params[:page]).per_page(3)
    elsif params[:products] == 'percent_off'
  ...
  def apparel
    if params[:products] == 'discounted'
      ...
      @products = Product.category_queried_products(params[:query], 'Apparel').page(params[:page]).per_page(3)
    elsif params[:products] == 'percent_off'
